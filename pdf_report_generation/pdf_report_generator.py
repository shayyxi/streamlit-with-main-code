...
def generate_property_summary_table(property_name, property_summary: dict[date, PropertySummary], pdf: FPDF):
    ...
    property_summary_table_data = (
        ...
        ("Percentage Leased", f"{property_summary_sanitized[today_date].leased_units_percentage}", f"{property_summary_sanitized[one_week_ago_sunday_date].leased_units_percentage}", f"{property_summary_sanitized[two_week_ago_sunday_date].leased_units_percentage}"),
